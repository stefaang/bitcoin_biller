# -*- coding: utf-8 -*-
"""
Created on Mon Dec 09 16:28:21 2013

@author: stefaan.ghysels

 Bitcoin address generation code by weex & Joric
 Original bitcoin address generation code can be found here:
...
def get_addr_from_seed(seed=None, rounds=1):
    return get_addr(gen_eckey(passphrase=seed, rounds=rounds))
